            ...
            <div style={{
                ...
                {gestures.map((gesture, index) => (
                    ...
                    >
                        ...
                        {/* 3. Note - Removed title as per request (keeping text if any) */}
                        {gesture.text && (
                            <div style={{ textAlign: 'center', width: '100%', minHeight: '1rem' }}>
                                <p style={{ fontSize: '1rem', color: theme.colors.text.primary, fontWeight: '500', lineHeight: '1.4', margin: 0 }}>
                                    {gesture.text}
                                </p>
                            </div>
                        )}

                        {/* 4. Referees - List Layout */}
