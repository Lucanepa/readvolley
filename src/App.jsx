            ...
            <AnimatePresence mode="wait">
                {!environment ? (
                    ...
                    >
                        ...
                        <div className="relative z-20 container mx-auto px-6 flex flex-col items-center mb-40 gap-12">
                            <motion.div
                            ...
                            >
                                <h1 className="text-6xl md:text-8xl font-black mb-4 tracking-tighter mb-40">
                                    VOLLEY<span className="text-beach-primary italic">RULES</span>
                                </h1>
                            </motion.div>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl h-[200px]">
                                <EnvironmentCard
                                    type="indoor"
                                    title="Volleyball"
...
function EnvironmentCard({ title, subtitle, icon, onClick, onHover, onBlur, accentColor }) {
    ...
    return (
        <motion.button
            ...
            onMouseLeave={onBlur}
            onClick={onClick}
            className={`group relative glass p-20 py-20 rounded-[20px] flex flex-col items-center justify-center text-center transition-all duration-500 border-2 border-white/5 ${borderClass} ${glowClass}`}
        >
